...
//			}
	...
	public static class IdAscendingAgeDeclineOrder implements Comparator<Student> {
...
//			return 0;
	...
	public static void main(String[] args) {
		...
		Arrays.sort(students, new IdAscendingAgeDeclineOrder());
		...
		studentList.sort(new IdAscendingAgeDeclineOrder());
